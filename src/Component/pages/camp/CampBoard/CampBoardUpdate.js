...
function UpdateBoard() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/camp/board/get/${camp_id}`)
      .then(response => {
  ...
  const handleUpdate = () => {
    axios.put(`http://localhost:8080/camp/board/edit/${camp_id}`, boardData, {
        headers: {
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => setBoardData({ ...boardData, user_id: parseInt(e.target.value, 10) })}
                />
              </td>
            </tr>
  ...
  <td className="radio-buttons-container">
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_select: '텐트' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_select: '글램핑' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_select: '카라반' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_select: '사이트' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_select: '펜션' })}
      />
...
<th className="table-primary">캠핑장 위치</th>
  <td className="radio-buttons-container">
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_location: '서울' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_location: '경기' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_location: '인천' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_location: '강원' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_location: '충청' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_location: '전라' })}
      />
    ...
    <div>
      <input
        ...
        onChange={() => setBoardData({ ...boardData, camp_location: '경상' })}
      />
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => setBoardData({ ...boardData, camp_address: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => setBoardData({ ...boardData, camp_name: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => setBoardData({ ...boardData, camp_phone: e.target.value })}
                />
              </td>
            </tr>
  ...
  <td>
    <input
      ...
      onChange={(e) => setBoardData({ ...boardData, camp_adult: e.target.value !== "" ? parseInt(e.target.value, 10) : 0 })}
    />
  </td>
</tr>
...
<tr>
  ...
  <td>
    <input
      ...
      onChange={(e) => setBoardData({ ...boardData, camp_child: e.target.value !== "" ? parseInt(e.target.value, 10) : 0 })}
    />
  </td>
</tr>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => setBoardData({ ...boardData, camp_price: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => setBoardData({ ...boardData, camp_image: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => setBoardData({ ...boardData, camp_description: e.target.value })}
                />
              </td>
            </tr>
